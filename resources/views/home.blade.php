    ...
    <div class="container">
        ...
        <div class="row mt-4">
            <div class="col-lg-4">
                ...
                <button type="button" class="btn btn-primary btn-lg" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Adicionar Transação</button>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                @foreach ($dados as $dado)
                                    <tr>
                                        <td>{{ $dado->id }}</td>
                                        <td><a href="editar/{{ $dado->id }}">{{ $dado->descricao }}</a></td>
                                        <td>{{ $dado->tipo }}</td>
                                        <td>{{ $dado->valor }}</td>
                                        <td><a href="eliminar/{{ $dado->id }}">Eliminar</a></td>
                                    </tr>
                                    @endforeach
